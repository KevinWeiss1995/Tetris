...
# Project:  tetris.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile tetris.pro
#############################################################################
...
DISTDIR = /Users/kweiss/Qt_projects/tetris/.tmp/tetris1.0.0
...
SOURCES       = main.cpp \
		tetrisboard.cpp moc_tetrisboard.cpp
OBJECTS       = main.o \
		tetrisboard.o \
		moc_tetrisboard.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		tetris.pro tetrisboard.h main.cpp \
		tetrisboard.cpp
QMAKE_TARGET  = tetris
DESTDIR       = 
...
EXPORT__QMAKE_STASH_ = /Users/kweiss/Qt_projects/tetris/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/kweiss/Qt_projects/tetris/tetris.pro
...
tetris.app/Contents/MacOS/tetris:  $(OBJECTS)  
	@test -d tetris.app/Contents/MacOS/ || mkdir -p tetris.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: tetris.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
...
tetris.app/Contents/Info.plist: 
	...
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.tetris,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.tetris,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,tetris,g" -e "s,@LIBRARY@,tetris,g" -e "s,\$${EXECUTABLE_NAME},tetris,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >tetris.app/Contents/Info.plist

all: Makefile \
		tetris.app/Contents/PkgInfo \
		tetris.app/Contents/Info.plist tetris.app/Contents/MacOS/tetris
...
distdir: FORCE
	...
	$(COPY_FILE) --parents tetrisboard.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp tetrisboard.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_tetrisboard.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_tetrisboard.cpp
moc_tetrisboard.cpp: tetrisboard.h \
...
moc_tetrisboard.o: moc_tetrisboard.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_tetrisboard.o moc_tetrisboard.cpp
